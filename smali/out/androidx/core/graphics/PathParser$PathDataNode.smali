...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_408
    ...
    if-eq v11, v0, :cond_3a5

    const/16 v0, 0x43

    if-eq v11, v0, :cond_36d

    const/16 v2, 0x48

    if-eq v11, v2, :cond_35b

    const/16 v2, 0x51

    if-eq v11, v2, :cond_32c

    const/16 v3, 0x56

    if-eq v11, v3, :cond_31a

    const/16 v3, 0x61

    if-eq v11, v3, :cond_2c7

    const/16 v3, 0x63

    if-eq v11, v3, :cond_28b

    const/16 v4, 0x68

    if-eq v11, v4, :cond_27a

    const/16 v4, 0x71

    if-eq v11, v4, :cond_248

    const/16 v5, 0x76

    if-eq v11, v5, :cond_236

    const/16 v1, 0x4c

    if-eq v11, v1, :cond_21c

    const/16 v1, 0x4d

    if-eq v11, v1, :cond_1e9
    ...
    if-eq v9, v4, :cond_178

    if-eq v9, v15, :cond_178

    if-eq v9, v2, :cond_178

    if-ne v9, v0, :cond_180
    ...
    .line 545
    .local v4, "reflectiveCtrlPointY":F
    if-eq v9, v3, :cond_1ae

    if-eq v9, v1, :cond_1ae

    if-eq v9, v0, :cond_1ae
